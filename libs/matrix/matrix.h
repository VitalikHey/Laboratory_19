#ifndef LABORATORY_19_MATRIX_H
#define LABORATORY_19_MATRIX_H
...
// возвращает 'истина', если все элементы массива array уникальные,
// иначе - 'ложь'
...
// выполняет сортировку строк матрицы m по
// неубыванию значения функции criteria применяемой для строк
void insertionSortRowsMatrixByRowCriteria(matrix m,
                                          int (*criteria)(int*, int));

// выполняет сортировку столбцов матрицы m по
